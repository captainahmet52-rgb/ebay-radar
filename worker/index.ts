...
import { createMetaPollCampaignsWorker } from "./jobs/meta-poll-campaigns";
...
const workers: Worker[] = [
  ...
  createMetaPollCampaignsWorker(connection),
...
console.log("  → meta-poll-campaigns    (concurrency: 1)");
