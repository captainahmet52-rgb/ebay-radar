...
Bu dosya projenin tek referans kaynağıdır. Codex her oturumda bunu
...
Stack, mevcut Codex agent'larına göre sabitlendi. Agent'lar
...
2b. Skills (yetenekler) — .Codex/skills/
Bu skill'ler .Codex/skills/ klasöründe dosya olarak durur (içerikleri bu
...
Kurulum: skills/ klasörünün tamamını projenin köküne .Codex/skills/
